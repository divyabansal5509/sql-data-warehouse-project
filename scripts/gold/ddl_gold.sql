...
--Rename columns to friendly and meaningful names(following the business naming rule conventions)
...
SELECT
    ...
    CASE    
        WHEN ci.cst_gndr !=  'n/a' THEN ci.cst_gndr  --CRM is treated as the primary source for gender
